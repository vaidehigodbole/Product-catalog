...
const mobileGrid = document.getElementById("mobileGrid") as HTMLDivElement;
const electronicsGrid = document.getElementById("electronicsGrid") as HTMLDivElement;
const accessoriesGrid = document.getElementById("accessoriesGrid") as HTMLDivElement;

function displayProducts(filteredProducts: Product[]) {
